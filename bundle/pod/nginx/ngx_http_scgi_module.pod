...
=head2 scgi_allow_upstream


B<syntax:> scgi_allow_upstream I<I<C<string>> ...>
...
=head2 scgi_bind_dynamic


B<syntax:> scgi_bind_dynamic I<C<on> E<verbar> C<off>>
...
=head2 scgi_request_dynamic


B<syntax:> scgi_request_dynamic I<C<on> E<verbar> C<off>>
