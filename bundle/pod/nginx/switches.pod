...
C<-l I<C<port>>>E<mdash>enable
L<nginx control REST API|https://docs.nginx.com/nginx/admin-guide/basic-functionality/runtime-control#control-api>
on a specified I<C<port>> or UNIX-domain socket (1.29.8).
