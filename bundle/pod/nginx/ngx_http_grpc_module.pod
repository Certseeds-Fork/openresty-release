...
=head2 grpc_allow_upstream


B<syntax:> grpc_allow_upstream I<I<C<address>>>
...
=head2 grpc_bind_dynamic


B<syntax:> grpc_bind_dynamic I<C<on> E<verbar> C<off>>
...
=head2 grpc_request_dynamic


B<syntax:> grpc_request_dynamic I<C<on> E<verbar> C<off>>
