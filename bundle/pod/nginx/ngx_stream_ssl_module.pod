...
=head2 ssl_certificate_compression


B<syntax:> ssl_certificate_compression I<C<on> E<verbar> C<off>>
...
Enables TLS 1.3
L<compression|https://datatracker.ietf.org/doc/html/rfc8879>
...
B<syntax:> ssl_ech_file I<I<C<file>>>
...
Specifies a I<C<file>> with encrypted ClientHello configuration
(C<ECHConfig>) in the
L<PEM|https://datatracker.ietf.org/doc/draft-farrell-tls-pemesni/>
format used to enable TLS 1.3
L<ECH|https://datatracker.ietf.org/doc/html/draft-ietf-tls-esni>
in shared mode.
...
=item C<$ssl_client_sigalg>




returns the
L<signature algorithm|https://www.iana.org/assignments/tls-parameters/tls-parameters.xhtml#tls-parameters-16>
...
=item C<$ssl_ech_outer_server_name>
...
L<ECH feature branch|https://github.com/openssl/openssl/tree/feature/ech>
