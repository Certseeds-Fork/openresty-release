...
=head2 uwsgi_allow_upstream


B<syntax:> uwsgi_allow_upstream I<I<C<string>> ...>
...
=head2 uwsgi_bind_dynamic


B<syntax:> uwsgi_bind_dynamic I<C<on> E<verbar> C<off>>
...
B<default:> I<HTTP_HOST $host$is_request_port$request_port>
...
if and only if there are no C<uwsgi_param> directives
...
=head2 uwsgi_request_dynamic


B<syntax:> uwsgi_request_dynamic I<C<on> E<verbar> C<off>>
...
=head2 uwsgi_ssl_certificate_cache


B<syntax:> uwsgi_ssl_certificate_cache I<C<off>>


B<syntax:> uwsgi_ssl_certificate_cache I<
    C<max>=I<C<N>>
    [C<inactive>=I<C<time>>]
    [C<valid>=I<C<time>>]>
...
The value
C<store>:I<C<scheme>>:I<C<id>>
can be specified instead of the I<C<file>> (1.29.0),
which is used to load a secret key with a specified I<C<id>>
and OpenSSL provider registered URI I<C<scheme>>, such as
L<C<pkcs11>|https://datatracker.ietf.org/doc/html/rfc7512>.
...
=head2 uwsgi_ssl_conf_command


B<syntax:> uwsgi_ssl_conf_command I<I<C<name>> I<C<value>>>
...
Several C<uwsgi_ssl_conf_command> directives
can be specified on the same level.
These directives are inherited from the previous configuration level
if and only if there are
no C<uwsgi_ssl_conf_command> directives
defined on the current level.
...
=head2 uwsgi_ssl_key_log


B<syntax:> uwsgi_ssl_key_log I<path>
