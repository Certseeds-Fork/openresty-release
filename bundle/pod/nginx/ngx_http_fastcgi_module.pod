...
=head2 fastcgi_allow_upstream


B<syntax:> fastcgi_allow_upstream I<I<C<string>> ...>
...
=head2 fastcgi_bind_dynamic


B<syntax:> fastcgi_bind_dynamic I<C<on> E<verbar> C<off>>
...
if and only if there are no C<fastcgi_param> directives
...
=head2 fastcgi_request_dynamic


B<syntax:> fastcgi_request_dynamic I<C<on> E<verbar> C<off>>
